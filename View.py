...
class View:
    ...
    def setup_player(self):
        ...
        #img = tk.PhotoImage(file="./icons/icon_dbms.png")
    ...
    def play_song(self):
        self.sel_song_index_touple=self.playList.curselection()
        try:
            if len(self.sel_song_index_touple)==0:
                raise NoSongSelectedError("Please select a song to play")
            self.song_name=self.playList.get(self.sel_song_index_touple[0])
    ...
    def remove_song(self):
        self.sel_song_index_touple=self.playList.curselection()
        print(type(self.sel_song_index_touple))
        try:
            if len(self.sel_song_index_touple)==0:
                raise NoSongSelectedError("Please select a song to remove")
            song_name=self.playList.get(self.sel_song_index_touple[0])


            self.playList.delete(self.sel_song_index_touple[0])
    ...
    def closewindow(self):
        c=messagebox.askyesno("Do you want to close","Are you sure!")
        if c==True:
